...
export const Archive = () => {
    ...
    return <div id="Archive" className="flex flex-col gap-20 items-center justify-center py-24 md:py-32 2xl:py-40">
        <div className="flex flex-col items-center w-screen px-6 md:px-20">
            <motion.h1
                ...
                className="text-3xl sm:text-4xl md:text-6xl font-medium text-AccentDark text-center max-w-[900px] ">
                Discover our standout projects that highlight our excellence and innovative design.</motion.h1>
        </div>
