...
export const Archive = () => {
    ...
    return <div className="flex flex-col gap-20 items-center justify-center py-40">
        <div className="flex flex-col items-center w-screen px-20">
            <h1 className="text-6xl font-medium text-AccentDark text-center max-w-[900px] ">
        ...
        <div className="flex flex-col items-center w-screen px-6">
            {works.map(({ name, description }, idx) => (
                <div key={idx} className={
                    ...
                    <h2 className="text-3xl font-medium text-accentDark w-full group-hover:text-AccentBright transition-all">{name}</h2>
                    ...
                    <p className="text-xl font-medium text-gray-600 w-full max-w-[675px] line-clamp-1 leading-[220%] group-hover:invert transition-all">{description}</p>
                </div>
            ))}
        </div>
